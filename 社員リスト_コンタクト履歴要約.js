...
・「今後のフォローポイント」以外の各項目の末尾に可能な範囲で対象年月などを括弧書きで記載 例：（2025年10月）、（2025年7月以降）、（2024年3月頃～2025年8月頃）
・冗長にならない範囲で簡潔に記載する
・該当する内容がない場合は、無理に記載せず、未該当であることが分かる形で示す
・客観的で人事向けの文体を用いる
・活動履歴に記載されていない内容については推測や新たな評価・判断を行わない
・活動履歴は時系列情報として扱い、記載内容の前後関係を考慮する
・各項目内の箇条書きは、時系列がある場合、必ず新しい情報から古い情報の順（降順）で記載する
・同一項目内で複数の期間が混在する場合も、記載順は最新の事象を最初に置く
・時系列が不明確な場合は、無理に並び替えず、原文の記載順を維持する
