...
・同一の内容は、必ず1つの出力項目にのみ記載し、他の項目には重複して記載しない
・複数の出力項目に該当しそうな内容がある場合は、最も自然な1つの項目にのみ記載する
・記載先の判断に迷う場合でも、内容を分割したり、複数項目に記載したりせず、どれか1項目にまとめて記載する
・課題に対して対応状況が記載されている場合は、合わせて記載する
`
              },
              {
                role: 'user',
